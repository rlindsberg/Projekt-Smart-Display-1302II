...
void sendCommands(){
  ...
  sprintf(commandBuffer[1], "AT+S.SCFG=ip_hostname,smart_display\r\n");
  ...
  sprintf(commandBuffer[6], "AT+S.SSIDTXT=smart_display\r\n");
...
void setupSocket(){
  static uint8_t commandSocket[]="AT+S.SOCKDON=2018,t\r\n";
